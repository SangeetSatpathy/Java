...
public class LottoMadness extends JFrame {
    ...
    public LottoMadness() {
        ...
        FlowLayout layout1 = new FlowLayout(FlowLayout.CENTER,
            10, 10);// another contructor of the FlowLayout - (where the components should be placed, # pixels of width away from other components, # pixels of height away from other components)
        option.add(quickpick);
        option.add(personal);// remember, you can't add the ButtonGroup as a whole to the layout manager, just the individual components that are also part of the ButtonGroup.
